...
func Register(router *gin.RouterGroup) {
	...
	router.GET("/lock/total", locktotalStatus)
	router.POST("/lock/staked", stakedStatus)
	router.POST("/lock/unstake", unstake)
	router.POST("/lock/unstake/status", unstakeStatus)
